...
class Ks {
    ...
    const PClass & get_p() const { return p; }
    PClass & get_mutable_p() { return p; }
    void set_p(const PClass & value) { this->p = value; }

    const PClass & get_a() const { return a; }
    PClass & get_mutable_a() { return a; }
    void set_a(const PClass & value) { this->a = value; }

    const PClass & get_s() const { return s; }
    PClass & get_mutable_s() { return s; }
    void set_s(const PClass & value) { this->s = value; }
};
...
class MasksProperty {
    ...
    const O & get_x() const { return x; }
    O & get_mutable_x() { return x; }
    void set_x(const O & value) { this->x = value; }
...
class It {
    ...
    std::shared_ptr<PClass> get_c() const { return c; }
    void set_c(std::shared_ptr<PClass> value) { this->c = value; }

    std::shared_ptr<E> get_o() const { return o; }
    void set_o(std::shared_ptr<E> value) { this->o = value; }

    std::shared_ptr<O> get_w() const { return w; }
    void set_w(std::shared_ptr<O> value) { this->w = value; }
    ...
    std::shared_ptr<P> get_p() const { return p; }
    void set_p(std::shared_ptr<P> value) { this->p = value; }
    ...
    std::shared_ptr<E> get_r() const { return r; }
    void set_r(std::shared_ptr<E> value) { this->r = value; }

    std::shared_ptr<E> get_sk() const { return sk; }
    void set_sk(std::shared_ptr<E> value) { this->sk = value; }

    std::shared_ptr<E> get_sa() const { return sa; }
    void set_sa(std::shared_ptr<E> value) { this->sa = value; }
};
...
class FluffyI {
    ...
    const std::vector<int64_t> & get_y() const { return y; }
    std::vector<int64_t> & get_mutable_y() { return y; }
    void set_y(const std::vector<int64_t> & value) { this->y = value; }
};
