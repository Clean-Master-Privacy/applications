...
public final class CipherSuite {
    ...
    public static final CipherSuite TLS_DHE_DSS_WITH_AES_256_CBC_SHA256 = init("TLS_DHE_DSS_WITH_AES_256_CBC_SHA256", R.styleable.AppCompatTheme_checkboxStyle);
    ...
    public static final CipherSuite TLS_DHE_RSA_WITH_AES_128_CBC_SHA256 = init("TLS_DHE_RSA_WITH_AES_128_CBC_SHA256", R.styleable.AppCompatTheme_autoCompleteTextViewStyle);
    ...
    public static final CipherSuite TLS_DHE_RSA_WITH_AES_256_CBC_SHA256 = init("TLS_DHE_RSA_WITH_AES_256_CBC_SHA256", R.styleable.AppCompatTheme_checkedTextViewStyle);
