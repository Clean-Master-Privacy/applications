...
public final class RealConnection extends Http2Connection$Listener implements Connection {
    ...
    private void connectSocket(int i, int i2, Call call, EventListener eventListener) throws IOException {
        ...
        try {
            ...
            try {
                this.source = k.b(k.h(this.rawSocket));
                this.sink = k.b(k.g(this.rawSocket));
    ...
    private void connectTls(okhttp3.internal.connection.ConnectionSpecSelector r8) throws java.io.IOException {
        /*
            ...
            r2 = 0
            java.net.Socket r3 = r7.rawSocket     // Catch:{ AssertionError -> 0x0107 }
            okhttp3.HttpUrl r4 = r0.url()     // Catch:{ AssertionError -> 0x0107 }
            java.lang.String r4 = r4.host()     // Catch:{ AssertionError -> 0x0107 }
            okhttp3.HttpUrl r5 = r0.url()     // Catch:{ AssertionError -> 0x0107 }
            int r5 = r5.port()     // Catch:{ AssertionError -> 0x0107 }
            r6 = 1
            java.net.Socket r1 = r1.createSocket(r3, r4, r5, r6)     // Catch:{ AssertionError -> 0x0107 }
            javax.net.ssl.SSLSocket r1 = (javax.net.ssl.SSLSocket) r1     // Catch:{ AssertionError -> 0x0107 }
            okhttp3.ConnectionSpec r8 = r8.configureSecureSocket(r1)     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            boolean r3 = r8.supportsTlsExtensions()     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            if (r3 == 0) goto L_0x0041
            okhttp3.internal.platform.Platform r3 = okhttp3.internal.platform.Platform.get()     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            okhttp3.HttpUrl r4 = r0.url()     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            java.lang.String r4 = r4.host()     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            java.util.List r5 = r0.protocols()     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            r3.configureTlsExtensions(r1, r4, r5)     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
        L_0x0041:
            r1.startHandshake()     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            javax.net.ssl.SSLSession r3 = r1.getSession()     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            okhttp3.Handshake r4 = okhttp3.Handshake.get(r3)     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            javax.net.ssl.HostnameVerifier r5 = r0.hostnameVerifier()     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            okhttp3.HttpUrl r6 = r0.url()     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            java.lang.String r6 = r6.host()     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            boolean r3 = r5.verify(r6, r3)     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            if (r3 == 0) goto L_0x00b0
            okhttp3.CertificatePinner r3 = r0.certificatePinner()     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            okhttp3.HttpUrl r0 = r0.url()     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            java.lang.String r0 = r0.host()     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            java.util.List r5 = r4.peerCertificates()     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            r3.check((java.lang.String) r0, (java.util.List<java.security.cert.Certificate>) r5)     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            boolean r8 = r8.supportsTlsExtensions()     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            if (r8 == 0) goto L_0x007f
            okhttp3.internal.platform.Platform r8 = okhttp3.internal.platform.Platform.get()     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            java.lang.String r2 = r8.getSelectedProtocol(r1)     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
        L_0x007f:
            r7.socket = r1     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            java.net.Socket r8 = r7.socket     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            okio.q r8 = okio.k.h(r8)     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            okio.e r8 = okio.k.b(r8)     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            r7.source = r8     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            java.net.Socket r8 = r7.socket     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            okio.p r8 = okio.k.g(r8)     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            okio.d r8 = okio.k.b(r8)     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            r7.sink = r8     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            r7.handshake = r4     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            if (r2 == 0) goto L_0x00a2
            okhttp3.Protocol r8 = okhttp3.Protocol.get(r2)     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            goto L_0x00a4
        L_0x00a2:
            okhttp3.Protocol r8 = okhttp3.Protocol.HTTP_1_1     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
        L_0x00a4:
            r7.protocol = r8     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
        ...
        L_0x00af:
            return
        L_0x00b0:
            java.util.List r8 = r4.peerCertificates()     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            r2 = 0
            java.lang.Object r8 = r8.get(r2)     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            java.security.cert.X509Certificate r8 = (java.security.cert.X509Certificate) r8     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            javax.net.ssl.SSLPeerUnverifiedException r2 = new javax.net.ssl.SSLPeerUnverifiedException     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            java.lang.String r4 = "Hostname "
            r3.<init>(r4)     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            okhttp3.HttpUrl r0 = r0.url()     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            java.lang.String r0 = r0.host()     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            r3.append(r0)     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            java.lang.String r0 = " not verified:\n    certificate: "
            r3.append(r0)     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            java.lang.String r0 = okhttp3.CertificatePinner.pin(r8)     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            r3.append(r0)     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            java.lang.String r0 = "\n    DN: "
            r3.append(r0)     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            java.security.Principal r0 = r8.getSubjectDN()     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            java.lang.String r0 = r0.getName()     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            r3.append(r0)     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            java.lang.String r0 = "\n    subjectAltNames: "
            r3.append(r0)     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            java.util.List r8 = okhttp3.internal.tls.OkHostnameVerifier.allSubjectAltNames(r8)     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            r3.append(r8)     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            java.lang.String r8 = r3.toString()     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            r2.<init>(r8)     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
            throw r2     // Catch:{ AssertionError -> 0x0101, all -> 0x00ff }
        L_0x00ff:
            r8 = move-exception
            goto L_0x0115
        L_0x0101:
        ...
        L_0x0107:
            r8 = move-exception
        L_0x0108:
            boolean r0 = okhttp3.internal.Util.isAndroidGetsocknameError(r8)     // Catch:{ all -> 0x0104 }
    ...
    private Request createTunnel(int i, int i2, Request request, HttpUrl httpUrl) throws IOException {
        ...
        while (true) {
            ...
            } else if (this.source.bYi().bYk() && this.sink.bYi().bYk()) {
                return null;
            } else {
